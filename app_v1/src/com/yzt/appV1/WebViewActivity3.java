...
public class WebViewActivity3 extends Activity {
	...
	private String lauchUrl="https://www.yingzt.com/invest?autoResponse=1";//启动url
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//webViewClient
		YZTWebViewClient yztWebClient=new YZTWebViewClient(WebViewActivity3.this);
		webView.setWebViewClient(yztWebClient);
		//webChromeClient
		YZTWebChromeClient yztWebChromeClient=new YZTWebChromeClient(WebViewActivity3.this);
