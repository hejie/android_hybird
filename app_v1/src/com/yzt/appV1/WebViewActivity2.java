...
public class WebViewActivity2 extends Activity {
	...
	private String lauchUrl="https://www.yingzt.com/yzt2.html?autoResponse=1";//启动url
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//webViewClient
		YZTWebViewClient yztWebClient=new YZTWebViewClient(WebViewActivity2.this);
		webView.setWebViewClient(yztWebClient);
		//webChromeClient
		YZTWebChromeClient yztWebChromeClient=new YZTWebChromeClient(WebViewActivity2.this);
